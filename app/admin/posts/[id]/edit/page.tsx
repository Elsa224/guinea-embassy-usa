  ...
  const handleSubmit = async (e: React.FormEvent, action: 'save' | 'publish') => {
    ...
    try {
      const submitData = {
        ...
        tags: selectedTags,
        publishedAt: action === 'publish' && formData.status !== 'PUBLISHED' 
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link href={`/admin/posts/${params.id}`}>
          ...
          <div>
            ...
            <p className="text-gray-600">Éditez le contenu et les paramètres</p>
          </div>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              <Select value={formData.categoryId} onValueChange={(value) => handleInputChange('categoryId', value)}>
                ...
                <SelectContent>
                  <SelectItem value="no">Aucune catégorie</SelectItem>
