...
export default function NotFound() {
    ...
    return (
        <Layout>
            <div className="min-h-screen bg-gradient-to-br from-orange-50 to-green-50 flex items-center justify-center py-12">
                    ...
                    <div className="mx-auto max-w-4xl text-center">
                        ...
                        >
                            <div className="relative">
                                {/* Large 404 */}
                                <motion.h1
                                    className="text-8xl sm:text-9xl lg:text-[12rem] font-black text-transparent bg-gradient-to-r from-orange-400 to-green-600 bg-clip-text opacity-20"
                                    animate={{ y: [0, -10, 0] }}
                                        ...
                                        {quickLinks.map((link, index) => (
                                            ...
                                            >
                                                <Button
                                                    ...
                                                    variant="ghost"
                                                    className="group h-auto w-full flex-col rounded-xl p-6 transition-all duration-300 hover:bg-gradient-to-r hover:from-orange-50 hover:to-green-50 hover:shadow-lg"
                                                >
                                                    <div className="mb-3 rounded-full bg-gradient-to-r from-orange-100 to-green-100 p-3 transition-transform duration-300 group-hover:scale-110">
                                                        {link.icon}
                                                    </div>
                        ...
                        <motion.div
                            ...
                            className="mt-8"
                        >
                            <div className="rounded-2xl bg-gradient-to-r from-orange-100/50 to-green-100/50 p-6">
                                ...
                                <div className="flex flex-col gap-2 text-sm text-gray-700 sm:flex-row sm:justify-center sm:gap-6">
                                    ...
                                    <span className="font-medium">🌐 express54.org</span>
                                </div>
                            </div>
                        </motion.div>
