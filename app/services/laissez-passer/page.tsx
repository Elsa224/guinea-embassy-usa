...
export default function LaissezPasserPage() {
    ...
    const title =
        page?.title?.[language] ||
        (language === "fr" ? "LAISSEZ-PASSER" : "TRAVEL PERMIT");
                                        ...
                                        >
                                            <Card className="h-full">
                                                <CardContent className="p-6 text-center">
                                                    <div
                                                        className={`mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-xl ${condition.color} shadow-lg`}
                                                    >
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-3">
                                            ...
                                            <div className="text-gray-700 space-y-1">
                                                <p>
                                                    Consulat Général de Côte
                                                    d'Ivoire
                                                </p>
                                                <p>
                                                    800 Second Avenue, Fifth
                                                    Floor
                                                </p>
