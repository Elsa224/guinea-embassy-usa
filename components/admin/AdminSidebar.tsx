    ...
    return (
        <div className="fixed left-0 top-0 z-40 h-screen w-64 bg-white dark:bg-gray-900 shadow-lg border-r border-gray-200 dark:border-gray-800 transition-colors">
            ...
            <div className="flex items-center gap-3 p-6 border-b border-gray-200 dark:border-gray-800">
                <div className="w-10 h-10 bg-ci-green rounded-lg flex items-center justify-center">
                    ...
                    return (
                        <Link
                            ...
                            className={cn(
                                ...
                                isActive
                                    ? "bg-orange-100 dark:bg-ci-orange/10 text-ci-orange dark:text-gray-100 shadow-sm border-l-4 bg-ci-orange"
                        ...
                        >
                            <Icon
                                className={cn(
                                    ...
                                    isActive
                                        ? "text-ci-orange"
                                        : "text-gray-500 dark:text-gray-400 group-hover:text-ci-orange dark:group-hover:text-gray-300"
                                )}
                            />
                            {item.title}
                        </Link>
