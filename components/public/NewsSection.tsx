        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center py-12">
            <div className="bg-red-50 border border-red-200 rounded-lg p-6 max-w-md mx-auto">
              <Newspaper className="w-12 h-12 text-red-400 mx-auto mb-4" />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center py-12">
            <div className="bg-gray-100 border border-gray-200 rounded-lg p-8 max-w-md mx-auto">
              ...
              <p className="text-gray-600 font-medium mb-2">Aucune actualité</p>
              <p className="text-gray-500 text-sm">
                Il n&apos;y a actuellement aucune actualité publiée.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4">
        ...
        {showViewAll && (
          <div className="text-center mt-12">
            <Button asChild size="lg" className="bg-ci-orange hover:bg-ci-orange-dark">
