...
const navigationItems = [
    ...
    },
    {
        ...
        dropdownItems: [
            // { label: "Gouvernance Générale", href: "/gouvernance" },
            { label: "La Présidence", href: "/gouvernance/le-president" },
            { label: "La Primature", href: "/gouvernance/le-premier-ministre" },
            { label: "Le Ministère des Affaires Etrangères", href: "/gouvernance/le-ministere-des-affaires-etrangeres" },
            { label: "Institutions de l'État", href: "/gouvernance/les-institutions-de-l-etat" },
            { label: "Communications", href: "/gouvernance/les-communications" },
            { label: "Jours Fériés", href: "/gouvernance/les-jours-feries" },
            // { label: "Le Gouvernement", href: "/gouvernance/le-gouvernement" },
        ],
    },
    {
        label: "Médiathèque",
